...
// TODO BGR - deactivated see below
...
module.exports = function (_webpackEnv, argv) {
  const isEnvDevelopment = argv.mode === "development"
  const isEnvProduction = !isEnvDevelopment
  process.env.NODE_ENV = isEnvDevelopment ? "development" : "production"
  console.log("Building mode:", process.env.NODE_ENV)
  ...
  return {
    ...
    optimization: {
      ...
      minimizer: [
        ...
        new TerserPlugin({
          ...
          // TODO: BGR de-activated - API changed
    ...
    resolve: {
      ...
      plugins: [
        ...
        PnpWebpackPlugin,
        //TODO: BGR: deactivated - thit creates issues with some Babel Loaders
    ...
    module: {
      // fix `Critical dependency: the request of a dependency is an expression` warning
      // due to dynamic dependency (see https://github.com/linways/table-to-excel/issues/12#issuecomment-511196381)
    ...
    plugins: [
      ...
      useTypeScript &&
        new ForkTsCheckerWebpackPlugin({
          ...
          issue: {
            include: [
              { origin: "eslint", file: "../**/src/**/*.{ts,tsx}" },
              { origin: "eslint", file: "**/src/**/*.{ts,tsx}" },
            ],
            exclude: [
              { origin: "eslint", file: "**/src/**/__tests__/**" },
              { origin: "eslint", file: "**/src/**/?(*.)(spec|test).*" },
              { origin: "eslint", file: "**/src/**/?(*.)(spec|test).*" },
              { origin: "eslint", file: "**/src/setupProxy.*" },
              { origin: "eslint", file: "**/src/setupTests.*" },
            ],
          },
    ...
    experiments: {
      ...
      // but then the entry point must be bootstrap.ts
    },
  }
}
